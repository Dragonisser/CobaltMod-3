...
public class CMSwordItem extends ToolItem implements Vanishable {
	private final float attackDamage;
	private final Multimap<EntityAttribute, EntityAttributeModifier> attributeModifiers;

	public CMSwordItem(ToolMaterial toolMaterial, int i, float f, Item.Settings settings) {
		...
		builder.put(EntityAttributes.GENERIC_ATTACK_SPEED, new EntityAttributeModifier(ATTACK_SPEED_MODIFIER_ID, "Weapon modifier", (double)f, Operation.ADDITION));
